...
public class SDES {
    ...
    public static void main(String[] args){
      int key1 = 0b0100011011;
      int key2 = 0b0100000011;
      String plainText = "plain text";
      System.out.println("Plaintext: " + plainText + ",  Key: " + key1);
// Encrypt plain text
      String cypherText = SDES.encrypt(plainText, key1);
      System.out.println("Encrypt1: " + cypherText);

      String cypherText2 = SDES.encrypt(cypherText, key2);
      System.out.println("Encrypt2: " + cypherText2);

      System.out.println("Switching keys...");

      cypherText = SDES.encrypt(plainText, key2);
      System.out.println("Encrypt1: " + cypherText);

      cypherText2 = SDES.encrypt(cypherText, key1);
      System.out.println("Encrypt2: " + cypherText2);

// Decrypt cypher text
      String decypheredText = SDES.decrypt(cypherText, key1);
    }
}